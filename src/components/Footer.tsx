...
import { MapPin, Phone, Mail, Facebook, Twitter, Instagram, Linkedin, Apple, ArrowUp } from 'lucide-react';
    ...
    <footer className="bg-gray-50 py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" className="w-9 h-9 flex items-center justify-center border border-gray-300 rounded hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-colors">
          ...
          {/* Quick Link Section */}
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Quick Link</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 text-sm hover:text-blue-600 transition-colors">
                  Privacy Policy
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-4">Save $3 With App & New User only</p>
            <div className="space-y-3">
              <a 
                href="#" 
                className="flex items-center gap-3 bg-gray-900 text-white px-4 py-3 rounded-lg hover:bg-gray-800 transition-colors"
              >
        ...
        <div className="border-t border-gray-200 pt-6 flex flex-col lg:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">
            © 2025. All rights reserved by <span className="font-semibold text-gray-900">Pimjo</span>.
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center flex-wrap justify-center gap-2">
              ...
              <div className="w-10 h-7 bg-white rounded border border-gray-200 flex items-center justify-center text-blue-700 font-bold text-xs">
                VISA
              </div>
              <div className="w-10 h-7 bg-white rounded border border-gray-200 flex items-center justify-center">
                <span className="text-blue-600 font-bold text-xs">P</span>
              </div>
              <div className="w-10 h-7 bg-white rounded border border-gray-200 flex items-center justify-center text-xs font-semibold text-gray-700">
                AMEX
              </div>
              <div className="w-10 h-7 bg-white rounded border border-gray-200 flex items-center justify-center">
